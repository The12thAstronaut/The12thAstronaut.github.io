...
<div>![image](/assets/images/erin_picture.png){:width="400px" style="float: left; padding-right:10px"}</div>
...
<div>![image](/assets/images/AshuMishra.png){:width="400px" style="float: left; padding-right:10px"}</div>
